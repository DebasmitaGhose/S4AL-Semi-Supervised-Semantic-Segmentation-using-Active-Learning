...
#print(ranks_02[0], "2%")
print(str(np.count_nonzero(ranks_02[0]<34)) + " elements are present out of 34 - 2%")

present_05 = np.in1d(uncert_names, s4gan_names_05)
ranks_05 = np.where(present_05==True)
#print(ranks_05, "5%")
print(str(np.count_nonzero(ranks_05[0]<85)) + " elements are present out of 85 - 5%")

present_125 = np.in1d(uncert_names, s4gan_names_125)
ranks_125 = np.where(present_125==True)
#print(ranks_125, "12.5%")
print(str(np.count_nonzero(ranks_125[0]<211)) + " elements are present out of 211 - 12.5%")

present_20 = np.in1d(uncert_names, s4gan_names_20)
ranks_20 = np.where(present_20==True)
#print(ranks_20, "20%")
print(str(np.count_nonzero(ranks_20[0]<338)) + " elements are present out of 338 - 20%")

present_33 = np.in1d(uncert_names, s4gan_names_33)
ranks_33 = np.where(present_33==True)
#print(ranks_33, "33%")
print(str(np.count_nonzero(ranks_33[0]<557)) + " elements are present out of 557 - 33%")

present_50 = np.in1d(uncert_names, s4gan_names_50)
ranks_50 = np.where(present_50==True)
#print(ranks_50, "50%")
print(str(np.count_nonzero(ranks_50[0]<845)) + " elements are present out of 845 - 50%")


present_75 = np.in1d(uncert_names, s4gan_names_75)
ranks_75 = np.where(present_75==True)
#print(ranks_75, "75%")
print(str(np.count_nonzero(ranks_75[0]<1267)) + " elements are present out of 1267 - 75%")
